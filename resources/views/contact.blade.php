    ...
    <div class="row justify-content-xl-center">
      <div class="col-12 col-xl-11">
        ...
        <div class="d-flex mb-5">
          ...
          <div>
            <h4 class="mb-3">{{__('main.Address')}}</h4>
        ...
        <div class="row mb-5">
          <div class="col-12 col-sm-6">
            <div class="d-flex mb-5 mb-sm-0">
              ...
              <div>
                <h4 class="mb-3">{{__('main.Phone Number')}}</h4>
                <p class="mb-0">
                  <a class="link-secondary text-decoration-none" href="">{{__('contact.phone')}}</a>
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="col-12 col-sm-6">
            <div class="col-12 col-sm-6">
              <div class="d-flex mb-0">
                ...
                <div>
                  <h4 class="mb-3">{{__('main.email')}}</h4>
                  <p class="mb-0">
                    <a class="link-secondary text-decoration-none" href="mailto:{{__('contact.email')}}">{{__('contact.email')}}</a>
                  </p>
                </div>
              </div>
            </div>
    ...
    <div class="container mt-4">
        <div class="row">
            <div class="col-md-6">
                <div class="card border-0 bg-light mb-4">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('feedback.store') }}" id="feedbackformdata">
                            @csrf
                            <div class="mb-3">
            ...
            <div class="col-md-6">
                <div class="card border-0 bg-light mb-4">
                    <div class="card-body">
                        <h5 class="card-title">{{ __('main.Our Location') }}</h5>
...
<script>
    let map = L.map('map').setView([40.0756, 44.4372], 13); // Coordinates for Aramvir and zoom level

    L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
        attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
    }).addTo(map);

    L.marker([40.0756, 44.4372]).addTo(map)
